...
\begin{columns}[T]
  ...
  \begin{column}{0.48\textwidth}
    % Steps 3-7: photos
    \only<3>{\includegraphics[width=0.9\linewidth]{figures/pd_control_01.png}}%
    \only<4>{\includegraphics[width=0.9\linewidth]{figures/pd_control_02.png}}%
    \only<5>{\includegraphics[width=0.9\linewidth]{figures/pd_control_03.png}}%
    \only<6>{\includegraphics[width=0.9\linewidth]{figures/pd_control_04.png}}%
    \only<7>{\includegraphics[width=0.9\linewidth]{figures/pd_control_05.png}}%
    % Step 8: simulation
    \only<8>{%
