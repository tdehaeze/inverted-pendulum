...
\title[TIPE Pendule Inversé]{Stabilisation active de systèmes en équilibre instable: du pendule aux lanceurs réutilisables}
\author{Thibaut \textsc{Dehaeze}} % Votre nom
...
\input{slides/1_introduction.tex}

% La 2e partie: Etude de la dynamique
\input{slides/2_dynamique.tex}

% La 3e partie: Controle par PID
\input{slides/3_control_pid.tex}

% La 4e partie: Controle par LQR
\input{slides/4_control_lqr.tex}

% Conclusion
\input{slides/5_conclusion.tex}
